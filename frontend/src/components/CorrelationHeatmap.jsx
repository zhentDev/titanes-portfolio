export default function CorrelationHeatmap({ correlations }) {
  ...
  return (
    <div className="card fade-up" style={{ padding: '20px' }}>
        ...
        <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '0.75rem' }}>
          <thead>
            <tr>
              ...
              {tickers.map((t) => (
                <th key={t} style={{ padding: '8px 10px', textAlign: 'center', color: 'var(--accent-primary)', fontWeight: 700 }}>
                  {t}
                </th>
              ))}
            </tr>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginTop: 12, fontSize: '0.68rem', color: 'var(--text-muted)' }}>
