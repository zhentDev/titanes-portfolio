export default function QuantitativeCard({ summary }) {
  ...
  return (
    <div className="card fade-up" style={{ padding: '20px' }}>
      ...
      >
        {/* Sharpe Ratio */}
        <div style={{ background: 'var(--bg-surface)', padding: '12px 14px', borderRadius: 'var(--radius)', border: '1px solid var(--border)' }}>
          <div style={{ fontSize: '0.68rem', color: 'var(--text-muted)', textTransform: 'uppercase', letterSpacing: '0.05em' }}>
            Sharpe Ratio
          </div>
          <div className="mono" style={{ fontSize: '1.3rem', fontWeight: 800, color: 'var(--accent-primary)', marginTop: 2 }}>
            {sharpe.toFixed(2)}
          </div>
        ...
        <div style={{ background: 'var(--bg-surface)', padding: '12px 14px', borderRadius: 'var(--radius)', border: '1px solid var(--border)' }}>
          ...
          <div className="mono" style={{ fontSize: '1.3rem', fontWeight: 800, color: 'var(--gain)', marginTop: 2 }}>
            {sortino.toFixed(2)}
          </div>
          <div style={{ fontSize: '0.65rem', color: '#94a3b8', marginTop: 2 }}>
            Solo riesgo bajista
        ...
        <div style={{ background: 'var(--bg-surface)', padding: '12px 14px', borderRadius: 'var(--radius)', border: '1px solid var(--border)' }}>
          ...
          <div className="mono" style={{ fontSize: '1.3rem', fontWeight: 800, color: 'var(--text-primary)', marginTop: 2 }}>
            {betaSP.toFixed(2)}
          </div>
          <div style={{ fontSize: '0.65rem', color: '#94a3b8', marginTop: 2 }}>
        ...
        <div style={{ background: 'var(--bg-surface)', padding: '12px 14px', borderRadius: 'var(--radius)', border: '1px solid var(--border)' }}>
          ...
          <div className="mono" style={{ fontSize: '1.3rem', fontWeight: 800, color: '#f59e0b', marginTop: 2 }}>
            {vol.toFixed(1)}%
          </div>
          <div style={{ fontSize: '0.65rem', color: '#94a3b8', marginTop: 2 }}>
        ...
        <div style={{ background: 'var(--bg-surface)', padding: '12px 14px', borderRadius: 'var(--radius)', border: '1px solid var(--border)' }}>
          ...
          <div className="mono" style={{ fontSize: '1.3rem', fontWeight: 800, color: winRate >= 50 ? 'var(--gain)' : 'var(--loss)', marginTop: 2 }}>
            {winRate.toFixed(1)}%
          </div>
          <div style={{ fontSize: '0.65rem', color: '#94a3b8', marginTop: 2 }}>
