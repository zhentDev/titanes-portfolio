        ...
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start" }}>
          <div>
            ...
            <p style={{ fontSize: "0.85rem", color: "var(--text-secondary)", marginBottom: 20 }}>
              Registra y trackea compras reales de ETFs, ETCs o Acciones con sus valores de apertura
              exactos.
            </p>
          </div>
        ...
        >
          ...
          <div
            style={{
              padding: 16,
              background:
                summary.netReturn >= 0 ? "rgba(34, 197, 94, 0.05)" : "rgba(239, 68, 68, 0.05)",
              borderRadius: "var(--radius)",
              border: `1px solid ${summary.netReturn >= 0 ? "rgba(34, 197, 94, 0.2)" : "rgba(239, 68, 68, 0.2)"}`,
            }}
          >
            <div
              style={{ fontSize: "0.75rem", color: summary.netReturn >= 0 ? "#4ade80" : "#f87171" }}
            >
            ...
            <div style={{ display: "flex", gap: 16, fontSize: "0.75rem" }}>
              ...
              <button
                ...
                style={{
                  ...
                  gap: 6,
                  color: "#ec4899",
                  opacity: visibleSeries.sp500 ? 1 : 0.4,
                }}
              >
              ...
              <button
                ...
                style={{
                  ...
                  gap: 6,
                  color: "#8b5cf6",
                  opacity: visibleSeries.nasdaq ? 1 : 0.4,
                }}
              >
                    ...
                    >
                      ...
                      >
                        ...
                        <div>
                          ...
                          <div className="mono" style={{ fontWeight: 700, color: "#00e5ff" }}>
                        ...
                        <div style={{ minWidth: 100 }}>
                          ...
                          <div
                            style={{
                              color: group.isPositive ? "#4ade80" : "#f87171",
                              fontWeight: 700,
                              fontSize: "0.9rem",
                            }}
                          >
                          ...
                          >
                            ...
                            <div style={{ textAlign: "right" }}>
                              ...
                              <div
                                style={{
                                  marginTop: 4,
                                  color: p.isPositive ? "#4ade80" : "#f87171",
                                  fontWeight: 700,
                                  fontSize: "0.8rem",
                                }}
                              >
                                Beneficio: {p.isPositive ? "+" : ""}${p.profit.toFixed(2)} (
                                {p.isPositive ? "+" : ""}
                                {p.profitPct.toFixed(2)}%)
                              </div>
                            </div>
